...
namespace AgencyPro.AgencyOwner.API.Controllers.v2
{
    public class PaymentTermController : OrganizationUserController
    {
        ...
        public PaymentTermController(IAgencyOwner agencyOwner, IServiceProvider serviceProvider, IPaymentTermService paymentTermService ) : base(serviceProvider)
        {
        ...
        {
            var result = await _paymentTermService.AddPaymentTermToOrganization(_agencyOwner, paymentTermId);
            return Ok(result);
        }
        ...
        {
            var result = await _paymentTermService.RemovePaymentFromOrganization(_agencyOwner, paymentTermId);
            return Ok(result);
        }
