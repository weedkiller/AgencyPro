...
namespace AgencyPro.Core.Extensions
{
    public static class UserExtension
    {
        ...
        public static string GetFullName(this string firstName, string lastName)
        {
            ...
            return string.Format("{0} {1}", firstName, !string.IsNullOrEmpty(lastName) ? lastName : string.Empty)
                .Trim();
        }
        ...
        public static string GetDisplayName(this string firstName, string lastName)
        {
            ...
            return string.Format("{0} {1}", firstName,
                !string.IsNullOrEmpty(lastName) ? lastName.Substring(0, 1) + "." : string.Empty).Trim();
        }
