    ...
    public partial class OrganizationProjections : Profile
    {
        public OrganizationProjections()
        {
            ...
            CreateMap<Organization, AgencyOwnerCounts>()
                ...
                .ForMember(x => x.Contracts, opt => opt.MapFrom(x => x.ProviderOrganization.Contracts.Count 
                                                            + x.RecruitingOrganization.RecruiterContracts.Count 
                                                            + x.MarketingOrganization.MarketerContracts.Count))
                ...
                .ForMember(x => x.WorkOrders, opt => opt.MapFrom(x => x.ProviderOrganization.WorkOrders.Count(y => y.Status != OrderStatus.Rejected)))
