...
namespace AgencyPro.Core.UserAccount.Enums
{
    ...
    {
        [Description(
            "You'll soon receive a SMS with instructions to verify your phone number and activate your account")]
        ...
        [Description("Email is invalid")] InvalidEmail,

        [Description("Phone is invalid")] InvalidPhone,

        [Description("Missing Tenant")] MissingTenant,

        [Description("Password is required")] MissingPassword,

        [Description("Username is required")] MissingUsername,
