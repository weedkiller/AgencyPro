...
namespace AgencyPro.Core.UserAccount
{
    public class UserAccountConstants
    {
        ...
        public class UserAccountDefaults
        {
        ...
        {
            internal const int DefaultPersistentCookieDays = UserAccountDefaults.TwoFactorAuthTokenDurationDays;
        ...
        public static class ValidationMessages
        {
            ...
            public const string AccountPasswordResetRequiresSecretQuestion =
                "AccountPasswordResetRequiresSecretQuestion";
            ...
            public const string UsernameCanOnlyStartOrEndWithLetterOrDigit =
