    ...
    public partial class OrganizationContractorProjections : Profile
    {
        public OrganizationContractorProjections()
        {
            ...
            CreateMap<OrganizationContractor, OrganizationContractorOutput>()
                ...
                .ForMember(x => x.Email, opt => opt.MapFrom(x => x.Contractor.Person.ApplicationUser.Email))
                .ForMember(x => x.PhoneNumber, opt => opt.MapFrom(x => x.Contractor.Person.ApplicationUser.PhoneNumber))
