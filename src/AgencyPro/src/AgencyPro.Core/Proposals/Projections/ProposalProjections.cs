        ...
        public ProposalProjections()
        {
            CreateMap<FixedPriceProposal, FixedPriceProposalOutput>()
                ...
                .ForMember(x => x.AccountManagerEmail,
                    opt => opt.MapFrom(
                        x => x.Project.AccountManager.Person.ApplicationUser.Email))
                .ForMember(x => x.AccountManagerPhoneNumber,
                    opt => opt.MapFrom(
                        x => x.Project.AccountManager.Person.ApplicationUser.PhoneNumber))
                ...
                .ForMember(x => x.ProjectManagerEmail,
                    opt => opt.MapFrom(
                        x => x.Project.ProjectManager.Person.ApplicationUser.Email))
                .ForMember(x => x.ProjectManagerPhoneNumber,
                    opt => opt.MapFrom(
                        x => x.Project.ProjectManager.Person.ApplicationUser.PhoneNumber))
                ...
                .ForMember(x => x.CustomerEmail,
                    opt => opt.MapFrom(x => x.Project.OrganizationCustomer.Customer.Person.ApplicationUser.Email))
                .ForMember(x => x.CustomerPhoneNumber,
                    opt => opt.MapFrom(x => x.Project.OrganizationCustomer.Customer.Person.ApplicationUser.PhoneNumber))
