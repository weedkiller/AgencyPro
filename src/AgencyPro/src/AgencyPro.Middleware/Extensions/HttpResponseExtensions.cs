...
namespace AgencyPro.Middleware.Extensions
{
    public static class Extensions
    {
        ...
        public static async Task ExecuteResultAsync(this HttpResponse httpResponse, object response,
        ...
        public static async Task ExecuteErrorAsync(this HttpResponse httpResponse, string description,
            string error = "", HttpStatusCode statusCode = HttpStatusCode.BadRequest)
        {
            if (string.IsNullOrEmpty(error))
                await ExecuteResultAsync(httpResponse, new {error_description = description}, statusCode);
            else
                await ExecuteResultAsync(httpResponse, new {error, error_description = description}, statusCode);
        }

        public static async Task ExecuteErrorAsync(this HttpResponse httpResponse, object response,
