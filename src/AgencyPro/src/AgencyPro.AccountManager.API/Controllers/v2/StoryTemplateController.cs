...
namespace AgencyPro.AccountManager.API.Controllers.v2
{
    public class StoryTemplateController : OrganizationUserController
    {
        ...
        {
            var templates = await _storyTemplateService.GetStoryTemplate(_accountManager, storyTemplateId);
            return Ok(templates);
        }
        ...
        {
            var templates = await _storyTemplateService.Delete(_accountManager, storyTemplateId);
            return Ok(templates);
        }
        ...
        {
            var templates = await _storyTemplateService.Create(_accountManager, input);
            return Ok(templates);
        }
